...
public class MobileCase {
    ...
    private String mobileCaseMaterial;
    private String mobileCaseColor;
    ...
    // mobileCaseMaterial
    public void setMobileCaseMaterial(String mobileCaseMaterial) {
        this.mobileCaseMaterial = mobileCaseMaterial;
    }

    public String getMobileCaseMaterial() {
        return mobileCaseMaterial;
    }

    // mobileCaseColor
    public void setMobileCaseColor(String mobileCaseColor) {
        this.mobileCaseColor = mobileCaseColor;
    }

    public String getMobileCaseColor() {
        return mobileCaseColor;
    }
    ...
    // mobileCaseWeight
    public void setMobileCaseWeight(String mobileCaseWeight) {
        this.mobileCaseWeight = mobileCaseWeight;
    }
