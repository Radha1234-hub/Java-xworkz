...
public class MultimeterRunner {
    public static void main(String[] args) {
        ...
        MultimeterDto ref22 = new MultimeterDto();
        ref22.setMultimeterId(2);
        ref22.setMultimeterBrand("Extech");
        ref22.setMultimeterType("Analog");
        ref22.setMultimeterMeasurement("Voltage, Current");
        ref22.setMultimeterAccuracy("±1.0%");
        ref22.setMultimeterDisplay("Analog Needle");
        ref22.setMultimeterPrice(4500.00);
