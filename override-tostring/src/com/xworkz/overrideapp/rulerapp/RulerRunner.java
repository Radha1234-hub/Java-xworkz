...
public class RulerRunner {
    public static void main(String[] args) {
        ...
        RulerDto ref22 = new RulerDto();
        ref22.setRulerId(2);
        ref22.setRulerType("Metal Ruler");
        ref22.setRulerMaterial("Stainless Steel");
        ref22.setRulerLength("15 cm");
        ref22.setRulerUsage("Precision Drawing & Drafting");
        ref22.setRulerBrand("Staedtler");
        ref22.setRulerPrice(150.00);
