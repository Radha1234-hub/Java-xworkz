...
public class SwitchesRunner {
    public static void main(String[] args) {
        ...
        SwitchesDto ref33 = new SwitchesDto();
        ref33.setSwitchesId(3);
        ref33.setSwitchesBrand("Havells");
        ref33.setSwitchesType("Touch Switch");
        ref33.setSwitchesMaterial("Glass Panel");
        ref33.setSwitchesCurrentRating("6A");
        ref33.setSwitchesColor("Blue");
        ref33.setSwitchesPrice(750.00);
