...
public class WrenchesRunner {
    public static void main(String[] args) {
        ...
        WrenchesDto ref11 = new WrenchesDto();
        ref11.setWrenchId(1);
        ref11.setWrenchType("Adjustable Wrench");
        ref11.setWrenchMaterial("Chrome Vanadium Steel");
        ref11.setWrenchBrand("Stanley");
        ref11.setWrenchUsage("Multipurpose");
        ref11.setWrenchSize("8-inch");
        ref11.setWrenchPrice(500.00);
