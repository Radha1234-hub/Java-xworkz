...
public class ArchitectRunner {
    public static void main(String[] args) {
        ...
        ArchitectDto ref11 = new ArchitectDto();
        ref11.setArchitectId(1);
        ref11.setArchitectName("Arjun");
        ref11.setArchitectSpecialization("Residential Design");
        ref11.setArchitectExperience("12 years");
        ref11.setArchitectFirm("Hiranandani Architects");
        ref11.setArchitectLocation("Mumbai");
        ref11.setArchitectSalary(1800000.00);
