...
public class DividerRunner {
    public static void main(String[] args) {
        ...
        DividerDto ref33 = new DividerDto();
        ref33.setDividerId(3);
        ref33.setDividerType("Spring Divider");
        ref33.setDividerMaterial("Aluminum Alloy");
        ref33.setDividerBrand("Bosch");
        ref33.setDividerUsage("Precision Measuring & Marking");
        ref33.setDividerSize("10 inches");
        ref33.setDividerPrice(600.00);

        System.out.println(ref3.toString());
        System.out.println(ref3.equals(ref33));
        System.out.println(ref33.hashCode());
    }
}
