...
public class CompassRunner {
    ...
    public static void main(String[] args) {
        ...
        CompassDto ref11 = new CompassDto();
        ref11.setCompassId(1);
        ref11.setCompassType("Magnetic Compass");
        ref11.setCompassMaterial("Brass");
        ref11.setCompassBrand("Silva");
        ref11.setCompassUsage("Navigation & Orienteering");
        ref11.setCompassSize("2 inches");
        ref11.setCompassPrice(800.00);
