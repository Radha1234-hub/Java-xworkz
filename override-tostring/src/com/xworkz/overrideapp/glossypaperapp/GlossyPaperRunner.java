...
public class GlossyPaperRunner {
    public static void main(String[] args) {
        ...
        GlossyPaperDto ref11 = new GlossyPaperDto();
        ref11.setPaperId(1);
        ref11.setPaperType("Photo Glossy");
        ref11.setPaperFinish("High-Gloss");
        ref11.setPaperWeight("250 gsm");
        ref11.setPaperUsage("Photographic Prints");
        ref11.setPaperSize("A4");
        ref11.setPaperPrice(500.00);



        System.out.println(ref3.toString());
        System.out.println(ref2.equals(ref11));
