...
public class EndDeviceRunner {
    public static void main(String[] args) {
        ...
        EndDeviceDto ref22 = new EndDeviceDto();
        ref22.setDeviceId(2);
        ref22.setDeviceName("Smartphone");
        ref22.setDeviceType("Communication");
        ref22.setDeviceManufacturer("Apple");
        ref22.setDeviceUsage("Calling, Messaging, Media");
        ref22.setDeviceConnectivity("Wi-Fi, 5G, Bluetooth");
        ref22.setDevicePrice(90000.00);
