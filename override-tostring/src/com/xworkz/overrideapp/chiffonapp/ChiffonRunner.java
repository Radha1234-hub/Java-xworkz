...
public class ChiffonRunner {
    public static void main(String[] args) {
        ...
        ChiffonDto ref22 = new ChiffonDto();
        ref22.setChiffonId(2);
        ref22.setChiffonType("Polyester Chiffon");
        ref22.setChiffonOrigin("China");
        ref22.setChiffonTexture("Light and Flowing");
        ref22.setChiffonUsage("Scarves and Casual Wear");
        ref22.setChiffonColor("Blue");
        ref22.setChiffonPrice(2500.00);
