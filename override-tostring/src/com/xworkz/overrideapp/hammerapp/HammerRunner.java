...
public class HammerRunner {
    public static void main(String[] args) {
        ...
        HammerDto ref22 = new HammerDto();
        ref22.setHammerId(2);
        ref22.setHammerType("Ball Peen Hammer");
        ref22.setHammerMaterial("Carbon Steel");
        ref22.setHammerBrand("DeWalt");
        ref22.setHammerUsage("Metalworking");
        ref22.setHammerWeight("24 oz");
        ref22.setHammerPrice(1200.00);
