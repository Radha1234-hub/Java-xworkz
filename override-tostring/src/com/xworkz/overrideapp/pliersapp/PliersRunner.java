...
public class PliersRunner {
    ...
    public static void main(String[] args) {
        ...
        PliersDto ref11 = new PliersDto();
        ref11.setPlierId(1);
        ref11.setPlierType("Needle Nose Pliers");
        ref11.setPlierMaterial("Carbon Steel");
        ref11.setPlierBrand("Stanley");
        ref11.setPlierUsage("Electrical Work");
        ref11.setPlierSize("6-inch");
        ref11.setPlierPrice(350.00);
