...
public class RouterRunner {
    ...
    public static void main(String[] args) {
        ...
        RouterDto ref11 = new RouterDto();
        ref11.setRouterId(1);
        ref11.setRouterBrand("TP-Link");
        ref11.setRouterModel("Archer AX50");
        ref11.setRouterType("Wi-Fi 6");
        ref11.setRouterSpeed("2400 Mbps");
        ref11.setRouterFrequency("Dual-band");
        ref11.setRouterPrice(6999.00);
