...
public class Organ {
    ...
    public void organDetails() {
        System.out.println("Organs are structural and functional units of the body.");
        System.out.println("Each organ has specific roles to maintain biological processes.");
