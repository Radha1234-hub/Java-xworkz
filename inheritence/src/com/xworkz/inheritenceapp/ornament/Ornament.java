...
public class Ornament {
    public void ornamentDetails() {
        System.out.println("Ornaments are decorative items worn to enhance appearance.");
        System.out.println("They are often made from materials like gold, silver, and gemstones.");
