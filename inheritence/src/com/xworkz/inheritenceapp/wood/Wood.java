...
public class Wood {
    public void woodDetails() {
        System.out.println("Wood is a natural material obtained from trees.");
        System.out.println("It is widely used for crafting furniture like tables, chairs, and cabinets.");
