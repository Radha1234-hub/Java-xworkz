...
public class Satellite {
    public void satelliteDetails() {
        System.out.println("Satellites are celestial bodies that orbit around a planet or a star.");
        System.out.println("They can be natural, like the Moon, or artificial, like communication satellites.");
