...
public class Leather {
    public void shoeDetails() {
        System.out.println("Shoes are a type of footwear designed to protect and comfort the feet.");
        System.out.println("They come in various materials, designs, and purposes.");
