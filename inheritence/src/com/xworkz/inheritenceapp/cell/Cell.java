...
public class Cell {
    public void cellDetails() {
        System.out.println("Cells are the basic structural and functional units of all living organisms.");
        System.out.println("They perform essential functions like energy production, growth, and reproduction.");
