...
public class Virus {
    ...
    public void virusDetails(){

            System.out.println("Pathogenicity: Viruses can cause severe diseases in humans, animals, and plants, leading to significant health, agricultural, and economic challenges. Examples include influenza, HIV, and crop-destroying viruses.");
            System.out.println("Rapid Mutation: Their ability to mutate quickly can make it difficult to develop effective vaccines or treatments, as they can evade immune responses and adapt to new hosts.");
