...
public class Hormone {
    public void hormoneDetails() {
        System.out.println("Hormones are chemical substances that act as messengers in the body.");
        System.out.println("They are secreted by glands in the endocrine system.");
